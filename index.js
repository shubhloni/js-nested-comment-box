            ...
            if (clickId.includes("reply")) {
                ...
                let newHtml = `
                    ...
                    <div class="comment-input-row">
                        <input type = "text" id = "content-${event.target.id.split("reply-")[1]}" >
                        <button id = "rplbtn-${event.target.id.split("reply-")[1]}" >Submit</button>
                    </div>
                    </li>
                    <ul>
                    `;
...
function addComment(author, content, id) {
    ...
    let newRpl = { id: oldCommentsArray.length, author: author, comment: content, parent: id, child: [] };
